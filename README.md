...
5 - Pretrained Model:
We provided [pre-trained models](https://drive.google.com/drive/folders/1WJapwgyyZHMAsm4toVPt1Q_vB6hBNx1j?usp=sharing) (1.4 GB) for SEED-V dataset as examples which can be downloaded from Google Drive. The downloaded folder contains pre-trained models of each 3-fold experiment for all 16 participants in all 6 few labeled scenarios. Save the downloaded to [this address](./eval_example.py#L86), and run the example of [evaluation code](./eval_example.py) using [bash file](./local_run.sh):
```
